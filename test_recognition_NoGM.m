...
%
function test_recognition_NoGM(train, test, C)
...
%HMM parameters
%[mu0, Sigma0] = mixgauss_init(nb_states*nb_gmm, reshape(seq_train', [nb_feature T*nex]), cov_type);
% model means and model covatiance

%
[mu0, Sigma0] = mixgauss_init(nb_states*nb_gmm, seq_train', cov_type); % change
...
[LL, prior1, transmat1, mu1, Sigma1, mixmat1] = ...
    mhmm_em(seq_train', prior0, transmat0, mu0, Sigma0, mixmat0, 'max_iter', 20);
